  ...
  $('[data-required]').each(function () {
    ...
    if (textInputs.length > 0) {
      $(textInputs).each(function () {
        ...
        if (formGroup.hasClass('form-group-day') || formGroup.hasClass('form-group-month') || formGroup.hasClass('form-group-year')) {
          formGroup = $(this).parents('fieldset').parents('.form-group');
          label = formGroup.find('legend');
          text = formGroup.find('legend').text();
        }
