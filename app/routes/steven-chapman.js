...
router.get('/', (req, res) => {
  res.redirect('/steven-chapman/start');
});
...
router.get('/start', (req, res) => {
  ...
  res.render('steven-chapman/start-page.html');
});
...
router.get('/details-partner', (req, res) => {
  res.render('steven-chapman/details-partner.html');
});
...
router.get('/details-yours', (req, res) => {
  ...
  res.render('steven-chapman/details-yours.html', {name});
});
...
router.get('/details-contact', (req, res) => {
  res.render('steven-chapman/details-contact.html');
});
...
router.get('/details-next-of-kin', (req, res) => {
  const name = req.cookies.deceasedName;
  res.render('steven-chapman/details-next-of-kin.html', {name});
});
...
router.get('/inform-organisations', (req, res) => {
  const name = req.cookies.deceasedName;
  res.render('steven-chapman/inform-organisations.html', {name});
});
...
router.get('/whats-been-done', (req, res) => {
  ...
  res.render('steven-chapman/whats-been-done.html', {date, bspElig, checklist});
});
...
router.get('/things-to-think-about', (req, res) => {
  ...
  res.render('steven-chapman/things-to-think-about.html', {bspElig, completeDate, randomDates, backLink, checklist});
});

router.get('/find-a-funeral-director', (req, res) => {
  const backLink = 'have-you-arranged-funeral';
  res.render('steven-chapman/find-a-funeral-director.html', {backLink});
});
...
router.get('/apply-for-sffp', (req, res) => {
  const backLink = 'whats-been-done';
  res.render('steven-chapman/apply-for-sffp.html', {backLink});
});
...
router.get('/apply-for-sffp-holding-page', (req, res) => {
  ...
  res.render('steven-chapman/apply-for-sffp-holding-page.html', {backLink});
});
...
router.get('/inheritance-tax', (req, res) => {
  const backLink = 'whats-been-done';
  res.render('steven-chapman/inheritance-tax.html', {backLink});
});
...
router.get('/inheritance-tax-holding-page', (req, res) => {
  ...
  res.render('steven-chapman/inheritance-tax-holding-page.html', {backLink});
});
...
router.get('/apply-for-bsp', (req, res) => {
  ...
  if (eligible) {
    res.render('steven-chapman/apply-for-bsp.html', {backLink});
  } else {
    res.redirect('things-to-think-about');
  }
});
...
router.get('/bsp-eligibility', (req, res) => {
  ...
  res.render('steven-chapman/bsp-eligibility.html', {backLink});
});
...
router.get('/bsp-exit', (req, res) => {
  ...
  res.render('steven-chapman/bsp-exit-page.html', {backLink});
});

router.get('/bsp-dependent-children', (req, res) => {
  const backLink = 'bsp-eligibility';
  res.render('steven-chapman/bsp-dependent-children.html', {backLink});
});
...
router.get('/bsp-bank-details', (req, res) => {
  ...
  res.render('steven-chapman/bsp-bank-details.html', {backLink});
});
...
router.get('/bsp-declaration', (req, res) => {
  ...
  res.render('steven-chapman/bsp-declaration.html', {backLink});
});
...
router.get('/bsp-end', (req, res) => {
  ...
  res.cookie('checklist', checklist);
  const completeDate = moment().format('DD MMMM YYYY');
  res.render('steven-chapman/bsp-end-page.html', {completeDate});
});
